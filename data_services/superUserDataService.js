...
module.exports = function(connection) {
    ...
    this.showRequests = function() {
        return queryService.executeQuery('select user.id as user_id, firstname, email, name from user inner join entity on user.entity_id = entity.id where status = \'pending\'');
    };

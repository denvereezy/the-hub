...
module.exports = function (connection) {
  ...
  this.rollupMetricsToDonor = function(questionnaire_metric_id){
        return queryService.executeQuery('UPDATE questionnaire_metric SET status = \'released\' WHERE id = ?', questionnaire_metric_id);
  };

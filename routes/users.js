                ...
                .then(function(results) {
                    ...
                    if (user !== undefined) {
                        ...
                        var mail = {
                            ...
                            text: data.firstName + ' you have been invited by ' + req.session.entity + ' to become a user. Please follow the link to setup your password. Your current email address is used to login.' + 'http://findivity.com/account/verifyaccount/' + data.token
                        };
